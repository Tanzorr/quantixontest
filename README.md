...
Данные из формы отправляються на http://127.0.0.1/data.php
Аякс запрос в scripts/custom.js после настроек карусели

Склонируйте проєкт,откройте в консоли и запуститу командой
docker-compose up -d
Или расместите содержимое www у себя на сервере.
...
* secure mysql users with proper source IP limitations# php_tutorials
# php_tutorials
# quantixontest
